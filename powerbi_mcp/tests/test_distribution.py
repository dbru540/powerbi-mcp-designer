...
class DistributionCheckTests(unittest.TestCase):
    ...
    def test_pyproject_exposes_expected_console_tools(self) -> None:
        ...
        self.assertEqual(project["name"], "powerbi-mcp-server-designer")
        self.assertEqual(project["version"], "0.2.0")
        self.assertEqual(
            project["scripts"]["powerbi-mcp-server-designer"],
    ...
    def test_dist_artifact_check_rejects_wheel_with_tests(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            wheel_path = dist_dir / "powerbi_mcp_server_designer-0.2.0-py3-none-any.whl"
            sdist_path = dist_dir / "powerbi_mcp_server_designer-0.2.0.tar.gz"
            ...
            with zipfile.ZipFile(wheel_path, "w") as wheel:
                ...
                wheel.writestr("powerbi_mcp_server_designer-0.2.0.dist-info/entry_points.txt", "")
