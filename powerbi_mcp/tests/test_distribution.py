...
class DistributionCheckTests(unittest.TestCase):
    ...
    def test_pyproject_exposes_expected_console_tools(self) -> None:
        ...
        self.assertEqual(project["name"], "powerbi-mcp-server-540")
        self.assertEqual(project["version"], "0.1.2")
        self.assertEqual(
            project["scripts"]["powerbi-mcp-server-540"],
    ...
    def test_dist_artifact_check_rejects_wheel_with_tests(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            wheel_path = dist_dir / "powerbi_mcp_server_540-0.1.2-py3-none-any.whl"
            sdist_path = dist_dir / "powerbi_mcp_server_540-0.1.2.tar.gz"
            ...
            with zipfile.ZipFile(wheel_path, "w") as wheel:
                ...
                wheel.writestr("powerbi_mcp_server_540-0.1.2.dist-info/entry_points.txt", "")
